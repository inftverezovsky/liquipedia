    ...
    <div className="space-y-6">
      ...
      <section className="rounded-3xl bg-white p-8 shadow-soft ring-1 ring-slate-200">
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          <div>
            <p className="text-sm font-bold uppercase tracking-widest text-slate-400">League of Legends</p>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_400px]">
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-3xl bg-white p-6 shadow-soft ring-1 ring-slate-200">
            ...
            <TournamentPlatformIdPanel tournamentId={tournament.id} initialPlatformId={tournament.platformId} disciplineSlug="leagueoflegends" />
          </section>
          ...
          <section className="rounded-3xl bg-slate-50 p-6 ring-1 ring-slate-200">
            ...
            <div className="grid grid-cols-2 gap-2">
              <a className="flex items-center justify-center rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm font-bold text-slate-700 hover:bg-slate-50 transition" href={`/api/leagueoflegends/tournament/${tournament.id}/export?format=json`}>JSON</a>
              <a className="flex items-center justify-center rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm font-bold text-slate-700 hover:bg-slate-50 transition" href={`/api/leagueoflegends/tournament/${tournament.id}/export?format=csv&type=matches`}>CSV</a>
            </div>
          </section>
        </div>
      </div>
      ...
      <section className="rounded-3xl bg-white p-8 shadow-soft ring-1 ring-slate-200">
        <details className="group">
          ...
          <div className="mt-8 border-t border-slate-100 pt-8">
            <TeamMappingPanel teamNames={[...teamNames]} initialMappings={mappings} disciplineSlug="leagueoflegends" />
          </div>
        </details>
      </section>
